...
flowchart LR;
    ...
    F --> |Fjern/Erstat| G;
```
## 0. Åben filen PycharmProjects/VTT6/uheld/uheld_loesning.sql i pgAdmin
...
## 6. Bearbejde data af hensyn til egenpart = Pedestrian with counterpart
- 6a. Gentag spørgsmål 5b. men kun hvor egenpart er Pedestrian with counterpart
